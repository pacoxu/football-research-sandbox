...
| --- | --- | --- | --- | --- | --- | --- |
| 中国 U17/U20/U23 完整名单 | 中国 U23 2026 已结构化 23/23；中国 U17 2026 已新增 `roster_boundary` 和 `tournament_participation[].roster_status`，其中 `final-squad` 正好 23 人、顾博宇为 `withdrawn/unused`，第四期集训单列为 `later-camp-callup`；中国 U20 2025 已区分原始终报名与更新赛事名单各 23 人，保留 Yuan Jianrui/Zhang Haoran 门将替换，并用四份官方 Match Summary 补齐 20 人、61 人次、3960 分钟和 8 球。 | 部分完成 | AFC final registration、CFA 集训/报名通知、AFC match reports。 | 每个年龄段有独立名单文件或清晰 roster flag，区分终报名、集训、观察池；字段含生日、位置、注册俱乐部、来源和核查日期。 | 2026-07-11 | 按需为中国 U17 第四期集训未映射名字建档；中国 U20 转入常规来源复核。 |
...
| 中国留洋历史代表样本 | `overseas-history.json` 已有中国 featured_records 21 条，big-five checklist 13 人；新增王大雷（仅试训 / 跟训）、周海滨（PSV 正式签约但一线队 0 场）、冯潇霆（南特试训 + 韩国正式履历）和贾秀全（游击队、大阪钢巴两段正式履历）。蒿俊闵、蒋光太、李金羽、李可、李玮锋、张呈栋仍适合拆成更明确的 featured records。 | 部分完成 | 俱乐部 / 足协 / 联赛官方档案优先，权威历史报道和公开数据库交叉；正式注册、试训、跟训与转会接触分开。 | checklist 每名球员都有 featured record 或明确 excluded note；五大联赛顶级联赛、梯队、低级别、仅试训分开。 | 2026-07-18 | 拆缺失 featured record issue，并继续核验贾秀全马来西亚阶段逐场统计。 |
| 亚洲其他国家对照组 | 澳大利亚 U17 2026、U20 2025 与乌兹别克 U17 2026 均已完成 23/23；澳大利亚名单含 AFC 高置信度报名层、赛事快照和 Football Australia 独立来源，乌兹别克名单含完整报名字段、Khusanov 留洋兑现样本与体系研究。沙特、伊朗、卡塔尔待补。 | 部分完成 | AFC final registration、AFC/FIFA match reports、各国足协/俱乐部 profile。 | 每个国家×赛事组合恰好 23 人；跨年龄名单按身份去重并保留多条赛事参与记录；转写冲突与留洋路径保留来源。 | 2026-07-13 | #48 交付后按 #49 增加澳大利亚 U23，并继续扩展沙特、伊朗、卡塔尔。 |
| UEFA Youth League 历史赛事 | 已建立 2013/14—2022/23 连续10季索引；9个已举办赛季含日期、赛制路径、四强、最佳射手、冠亚军与决赛信息，2020/21 明确记录为疫情取消且未产生比赛；2021/22 官方最佳射手口径差异已显式保留。最近3季另有完整参赛队和八强起逐场详情。 | 赛季索引完成，历史逐场待补 | UEFA history、当季 dates/format、competition regulations、match centre、records 与取消公告。 | 历史赛季连续、取消与缺数据严格区分、每季有来源版本和覆盖状态；完整参赛队及逐场比赛按状态分阶段补齐。 | 2026-07-18 | 第二阶段补2013/14—2022/23完整参赛队清单，再按赛季扩展淘汰赛和逐场赛果。 |
...
| P4 | [#17](https://github.com/starryjog/football-research-sandbox/issues/17) 亚洲其他国家 U17/U20/U23 对照组 | #47、#48 已分别交付澳大利亚 U20、U17 完整 23 人；#48 合并后从 #49 澳大利亚 U23 继续串行处理。 |
