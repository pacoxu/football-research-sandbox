...
| Eyeball | https://www.eyeball.club/ | 青少年足球视频与数据球探。 | 已在 `scouting-watchlist.json.source_audits` 建立公开来源审计；登录后可继续发现球员。 | Portal 球员库、视频、评分和详细数据需要登录；公开材料只作 S3 线索，发现后必须回查官方/俱乐部。 |
...
### Eyeball 亚洲公开来源审计（2026-08-19）

- Eyeball Portal 当前未提供无需登录的球员检索；公开官网说明平台支持按年龄、位置、国籍和俱乐部筛选，但不能据此导出或猜测球员名单。
- Eyeball 官方 LinkedIn 公开点名了 4 名在 2025 冬窗转入沙特联赛、此前可在平台观察的 U21 球员：Unai Hernández、Miguel Carvalho、Moses Turay、Matheus Machado。
- 4 人分别为西班牙、西班牙、塞拉利昂和巴西国籍，均不是 AFC 国籍球员。因此只进入 `source_audits[].asia_linked_leads`，标记为“目的俱乐部位于 AFC 成员协会”的亚洲联赛关联线索，不计入亚洲球员人数。
- 每条线索使用沙特职业联赛官方页面交叉核验出生年、国籍和沙特联赛节点；Eyeball 帖文与联赛页都不用于推断 Eyeball 私有评分。
- 公开审计得到的 AFC 国籍具名球员数为 0。后续只有在已授权登录态中完成可复核筛选，或 Eyeball 发布新的公开具名案例，才增加 AFC 球员记录。
