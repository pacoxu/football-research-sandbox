...
| 优先级 | 工作项 | 目标产物 | 关联 |
| --- | --- | --- | --- |
| P0 | 近期赛事状态与入口统计同步 | 银川 U17 和日韩 U21 快照已收口；新增上海明日之星 U17 及 2030 世界杯资格快照，README、Roadmap、覆盖矩阵统一为 459 名球员、22 项赛事、9 个专题项目 | [#5](https://github.com/pacoxu/football-research-sandbox/issues/5) |
| P0 | FIFA World Cup 2030 资格维护 | 六个举办国已按 FIFA 官方结论记为自动晋级，主办类型、所属足联、晋级日期和来源分开记录；后续跟进剩余 42 席、资格赛与抽签 | [#64](https://github.com/pacoxu/football-research-sandbox/issues/64) |
