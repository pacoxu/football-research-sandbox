...
| 优先级 | 工作项 | 目标产物 | 关联 |
| --- | --- | --- | --- |
| P0 | 近期赛事状态与入口统计同步 | 银川 U17 和日韩 U21 快照已收口；新增上海明日之星 U17 赛前快照与 28 人集训名单，README、Roadmap、覆盖矩阵统一为 459 名球员、21 项赛事、9 个专题项目 | [#5](https://github.com/pacoxu/football-research-sandbox/issues/5) |
